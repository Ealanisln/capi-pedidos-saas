    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <article className="rounded-3xl border border-white/70 bg-white/90 p-5 shadow-xl shadow-slate-900/5">
          ...
          <p className="mt-2 text-4xl font-black text-slate-950">{formatNumber(categories)}</p>
        </article>
        <article className="rounded-3xl border border-white/70 bg-white/90 p-5 shadow-xl shadow-slate-900/5">
          <p className="text-sm font-bold text-slate-500">Productos</p>
          <p className="mt-2 text-4xl font-black text-slate-950">{formatNumber(products)}</p>
        </article>
        <article className="rounded-3xl border border-white/70 bg-white/90 p-5 shadow-xl shadow-slate-900/5">
          <p className="text-sm font-bold text-slate-500">Pedidos activos</p>
          <p className="mt-2 text-4xl font-black text-slate-950">{formatNumber(activeOrders.length)}</p>
