      ...
      <section className="relative isolate px-4 py-5 md:py-8">
        ...
        <nav className="mx-auto flex w-full max-w-7xl items-center justify-between rounded-full border border-[#13201d]/10 bg-white/70 px-4 py-3 shadow-sm backdrop-blur md:px-5">
          ...
          <Link
            ...
            className="rounded-full bg-[#13201d] px-3 py-3 text-[0.68rem] font-black uppercase tracking-[0.10em] sm:px-4 sm:text-xs sm:tracking-[0.16em] text-white shadow-lg shadow-[#13201d]/15 transition hover:-translate-y-0.5 hover:bg-[#203731]"
          >
            Ver demo
          </Link>
        </nav>

        <div className="mx-auto grid w-full max-w-7xl gap-8 pb-12 pt-10 sm:gap-10 sm:pb-16 sm:pt-14 lg:grid-cols-[1.04fr_0.96fr] lg:items-center lg:pb-24 lg:pt-20">
          <div>
            <div className="inline-flex flex-wrap items-center gap-2 rounded-full border border-[#057564]/20 bg-white/75 px-4 py-2 shadow-sm backdrop-blur">
              ...
              <span className="text-[0.65rem] font-black uppercase tracking-[0.12em] text-[#057564] sm:text-xs sm:tracking-[0.22em]">
                Rafael Noh - Soluciones Tecnológicas Playa del Carmen
              </span>
            </div>
            <h1 className="mt-7 max-w-5xl font-[family-name:var(--font-display)] text-4xl font-black leading-[0.92] tracking-[-0.05em] text-[#13201d] sm:text-6xl lg:text-8xl">
            ...
            <div className="mt-8 grid gap-3 sm:flex sm:flex-wrap">
              <Link
                href="#planes"
                className="rounded-2xl bg-[#13201d] px-5 py-4 text-center text-xs font-black uppercase tracking-[0.10em] sm:px-6 sm:text-sm sm:tracking-[0.12em] text-white shadow-xl shadow-[#13201d]/20 transition hover:-translate-y-0.5 hover:bg-[#203731]"
              >
                Ver planes
              </Link>
              <Link
                href="#demos"
                className="rounded-2xl border border-[#13201d]/15 bg-white px-5 py-4 text-center text-xs font-black uppercase tracking-[0.10em] sm:px-6 sm:text-sm sm:tracking-[0.12em] text-[#13201d] shadow-sm transition hover:-translate-y-0.5 hover:bg-[#fffdf8]"
              >
                Probar demos
              </Link>
            </div>
            <div className="mt-9 grid gap-3 grid-cols-2 sm:grid-cols-4">
              {proof.map((item) => (
              ...
              <div className="rounded-[2rem] bg-[radial-gradient(circle_at_top_left,#28e0b9,transparent_30%),linear-gradient(150deg,#162722,#07110f)] p-5 text-white">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <h2 className="mt-2 font-[family-name:var(--font-display)] text-3xl font-black leading-none sm:text-4xl">Taquería Don José</h2>
        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 font-[family-name:var(--font-display)] text-3xl font-black leading-none tracking-[-0.04em] sm:text-4xl lg:text-6xl">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {plans.map((plan) => (
              ...
              >
                ...
                <h3 className="mt-5 font-[family-name:var(--font-display)] text-3xl font-black sm:text-4xl">{plan.name}</h3>
